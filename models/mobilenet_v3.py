...
def build_mobilenet_v3(input_shape=(224,224,3), num_classes=1000, model_type='large', pooling_type='avg', include_top=True):
    ...
    net = __conv2d_block(inputs, 16, kernel=(3, 3), strides=(1, 1), is_use_bias=False, padding='same', activation='HS')
    ...
    net = keras.layers.Conv2D(1280, (1, 1), strides=(1, 1), padding='valid', use_bias=True,
                              kernel_initializer='he_normal')(net)

    net = keras.layers.BatchNormalization(momentum=0.9, epsilon=1e-5)(net)
    net = keras.layers.Activation(Hswish)(net)
    ...
    #net = keras.layers.Conv2D(1280, (1, 1), strides=(1, 1), padding='valid', use_bias=True,kernel_initializer='he_normal')(net)
    ...
    if include_top:
        ...
        #net = keras.layers.Conv2D(num_classes, (1, 1), strides=(1, 1), padding='valid', use_bias=True,kernel_initializer='he_normal')(net)
...
large_config_list = [[16,  (3, 3), (1, 1), 16,  False, False, False, 'RE',  0],
                     [24,  (3, 3), (1, 1), 64,  False, False, False, 'RE',  1],#strides=(2, 2)=>(1,1)
...
if __name__ == '__main__':
    ...
    model = MobileNetV3Large(include_top=True,input_shape=(32,32,3), num_classes=100, pooling='avg')
    print(model.summary())
